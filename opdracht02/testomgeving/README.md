...
Modify the [Vagrantfile](Vagrantfile) to select your favourite base box. I usually go for base boxes from the [Bento project](https://app.vagrantup.com/bento), e.g. `bento/centos-8`. This is probably the only time you need to edit the `Vagrantfile`.
...
- `ip:` The IP address for the VM. Vagrant will create a host-only network if needed.
